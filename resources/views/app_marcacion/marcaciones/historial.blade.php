                                ...
                                @if($m)
                                    ...
                                    @else
                                        ...
                                        <div class="flex items-center p-4 bg-gray-50/50 border-b border-gray-50">
                                            <div class="w-10 h-10 rounded-full flex-shrink-0 flex items-center justify-center bg-gray-200 text-gray-400 border border-gray-300 border-dashed">
    ...
    <div id="modal-detalle" class="fixed inset-0 z-[100] hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-x-0 bottom-0 bg-white rounded-t-[30px] shadow-2xl transform transition-transform duration-300 overflow-hidden max-w-md mx-auto">
            ...
            <div class="p-6 pb-10">
                ...
                {{-- Caja de Permiso Texto --}}
                <div id="modal-permiso-box" class="hidden mb-6 bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-start gap-3 transition-all">
                    <div class="bg-white p-2 rounded-full text-blue-500 shadow-sm shrink-0 flex items-center justify-center w-8 h-8">
