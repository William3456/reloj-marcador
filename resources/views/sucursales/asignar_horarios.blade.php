                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
                            ...
                            <div class="p-5 space-y-5">
                                ...
                                <div>
                                    <label for="horario"
                                        class="block text-xs font-bold text-gray-500 uppercase mb-1">Horario disponible *</label>
                                    <div class="relative">
                                        <select id="horario"
                                            class="pl-2 block w-full rounded-lg border-gray-300 bg-gray-50 focus:bg-white focus:ring-blue-500 focus:border-blue-500 text-sm">
                        ...
                        <div class="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
                            <div class="bg-gray-50 px-5 py-3 border-b border-gray-200">
                                <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wide">
                                    <i class="fas fa-info-circle mr-2 text-blue-500"></i> Días laborales de la sucursal
                                </h3>
                            </div>
                            <div class="p-4">
                                <div id="info-dias-sucursal" class="flex flex-wrap gap-2 text-sm text-gray-600">
                                    <span class="italic text-gray-400">Selecciona una sucursal para ver sus días...</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody id="tabla-body" class="bg-white divide-y divide-gray-200">
                                        <tr id="row-empty">
                                            <td colspan="4" class="px-6 py-10 text-center text-gray-400 text-sm">
                                                Selecciona una sucursal y agrega horarios para comenzar.
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
