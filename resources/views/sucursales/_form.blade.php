<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <details
            ...
            <summary
                class="cursor-pointer font-medium text-blue-600 p-2 hover:bg-blue-100 rounded-t-lg select-none flex items-center gap-2 text-xs">
            ...
            <div class="p-3 pt-0 border-t border-blue-100 group-open:pt-3">
                <p class="mb-3 text-xs text-gray-500 text-justify leading-relaxed">
                    Los celulares pierden precisión bajo techo o entre muros gruesos. Este margen es una
                    <strong>tolerancia técnica</strong> para evitar que el sistema rechace marcaciones válidas cuando la
    ...
    <div class="md:col-span-2">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 bg-gray-50 p-4 rounded-lg border mt-1">
            @foreach ($dias as $dia)
                <label
                    class="flex items-center gap-2 p-2 bg-white rounded-md border hover:bg-gray-100 cursor-pointer shadow-sm">
